    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item"style={mystyle}>
          <a className="nav-link active" aria-current="page" href="./components/body">Home</a>
          </li>
          <li className="nav-item"style={mystyle}>
          <a className="nav-link active" aria-current="page" href="./components/Skills">Skills</a>
          </li>
          <li className="nav-item"style={mystyle}>
        ...
        <li className="nav-item"style={mystyle}>
          ...
          <li className="nav-item"style={mystyle}>
          <a className="nav-link" href="#"><img src="https://www.clipartmax.com/png/middle/256-2569207_instagram-icon-transparent-background-instagram-logo.png" alt="Insta" style={{height:'29px'}} /></a>
          </li> 
